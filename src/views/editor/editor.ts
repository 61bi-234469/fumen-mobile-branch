...
export const getFieldLayout = (
    ...
    const blockSize = Math.min(
        ...
        (canvasSize.width - 90) / 10.5,  // 讓ｪ縺ｮ繧ｹ繝壹・繧ｹ縺梧怙菴弱〒繧・0px縺ｯ谿九ｋ繧医≧縺ｫ縺吶ｋ
    ) - 1;
...
const ScreenField = (state: State, actions: Actions, layout: EditorLayout) => {
    ...
    // 繝・ヨ隴懊・莉墓ｧ倥↓繧医ｊ縲∵怙蛻昴・繝壹・繧ｸ縺ｮ繝輔Λ繧ｰ縺悟・菴薙↓蜿肴丐縺輔ｌ繧・
    // SRS OFF 譎ゅ・繧ｯ繝ｩ繧ｷ繝・け濶ｲ繧貞━蜈医☆繧具ｼ・t 逶ｸ蠖薙・謖吝虚・・
    ...
    const getChildren = () => {
        const getMode = () => {
            ...
            default: {
                // ModeTypes.Drawing遲峨・譛ｪ蟇ｾ蠢懊Δ繝ｼ繝峨・toolMode縺ｫ繝輔か繝ｼ繝ｫ繝舌ャ繧ｯ
                return toolMode({
                    layout,
                    actions,
                    grayAfterLineClear: state.tree.grayAfterLineClear,
        ...
        return [   // canvas:Field 縺ｨ縺ｮ繝槭ャ繝斐Φ繧ｰ逕ｨ莉ｮ諠ｳDOM
            KonvaCanvas({  // canvas遨ｺ髢薙・縺ｿ
                actions,
    ...
    // 繝輔ぅ繝ｼ繝ｫ繝峨お繝ｪ繧｢繧偵け繝ｪ繝・け縺励◆繧峨ヵ繧ｩ繝ｼ繧ｫ繧ｹ繧堤ｧｻ蜍包ｼ医く繝ｼ繝懊・繝峨す繝ｧ繝ｼ繝医き繝・ヨ譛牙柑蛹悶・縺溘ａ・・
    const handleFieldClick = (event: MouseEvent) => {
        const target = event.target as HTMLElement;
        // 繧ｳ繝｡繝ｳ繝亥・蜉帶ｬ・ｻ･螟悶ｒ繧ｯ繝ｪ繝・け縺励◆蝣ｴ蜷医√ヵ繧｣繝ｼ繝ｫ繝峨↓繝輔か繝ｼ繧ｫ繧ｹ繧堤ｧｻ蜍・
    ...
    return div({
        key: 'field-top',
        id: 'field-top',
        tabIndex: -1, // 繝輔か繝ｼ繧ｫ繧ｹ蜿ｯ閭ｽ縺ｫ縺吶ｋ・・ab縺ｧ縺ｯ遘ｻ蜍輔＠縺ｪ縺・ｼ・
        style: style({
            display: 'flex',
            ...
            alignItems: 'center',
            userSelect: 'none',
            outline: 'none', // 繝輔か繝ｼ繧ｫ繧ｹ譎ゅ・譫邱壹ｒ豸医☆
        }),
...
export const view: View<State, Actions> = (state, actions) => {
    ...
    return div({
        ...
        onupdate: batchDraw,
        key: 'view',
    }, [ // Hyperapp縺ｧ縺ｯ譛荳贋ｽ阪・繝弱・繝峨′譛蠕後↓螳溯｡後＆繧後ｋ
